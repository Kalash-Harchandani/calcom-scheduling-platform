...
const Hero = () => {
  ...
  return (
    <section className="border-b border-black/5 bg-[#f5f5f7]">
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 pb-16 pt-12 md:px-6 md:pb-24 md:pt-20 lg:flex-row lg:items-center lg:gap-14">
        {/* Left content */}
        <div className="flex-1 max-w-xl">
          ...
          <h1 className="mt-4 text-3xl font-semibold tracking-tight text-[#111111] md:text-5xl lg:text-[44px] lg:leading-tight">
            The better way to schedule your meetings
          </h1>
          <p className="mt-4 max-w-lg text-sm leading-relaxed text-[#3c3c43] md:text-base">
        ...
        <div className="flex-1">
          <div className="relative rounded-[32px] bg-white p-4 shadow-[0_18px_60px_rgba(0,0,0,0.08)] ring-1 ring-black/5 md:p-6 lg:p-7">
            {/* Window chrome */}
              ...
              <div className="flex flex-col gap-3 border-t border-black/5 pt-4 text-xs text-[#3c3c43] md:border-l md:border-t-0 md:pl-6 md:pt-0">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[10px] text-[#a1a1aa]">Asia/Kolkata</p>
                  </div>
