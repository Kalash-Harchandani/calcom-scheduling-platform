  ...
  return (
    <section className="border-b border-black/5 bg-[#f5f5f7]">
      <div className="mx-auto max-w-6xl px-4 py-14 md:px-6 md:py-18 lg:py-20">
        <h2 className="text-center text-2xl font-semibold tracking-tight text-[#111111] md:text-3xl">
          Loved by teams of all sizes
        </h2>
        <p className="mt-3 text-center text-sm text-[#3c3c43] md:text-base">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#6e6e73]">{item.handle}</p>
                </div>
              </div>
              <p className="mt-3 text-xs leading-relaxed text-[#3c3c43]">
                {item.text}
              </p>
            </article>
          ))}
